  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="salon-belleza-pilar-ramirez";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="SALON BELLEZA Pilar Ramírez"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="salon-belleza-pilar-ramirez"
          data-primary-color="#7c6557"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="salon-belleza-pilar-ramirez";
